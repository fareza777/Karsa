...
// Urutan model untuk dicoba: model terpilih dulu, lalu sisa allowedModels.
// Untuk gambar (vision) cukup satu model. Maks 3 percobaan.
export function buildModelCandidates(chosen, cfg, hasImages) {
  if (hasImages) return [chosen];
