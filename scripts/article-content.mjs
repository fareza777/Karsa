...
'custom-domain-karsa': `
  ...
  'website-toko-pakaian-thrift': `
      ...
      <h2>Mulai sekarang</h2>
      <p>Buka <a href="/app">KARSA</a>, salin prompt di atas, ganti nama toko, nomor WhatsApp, dan warna sesuai brand thrift kamu, lalu klik preview. Iterasi sampai grid katalog terasa pas dan tombol WhatsApp tidak menutupi foto. Publish ke <code>namatoko.karsa.work</code> atau pasang custom domain supaya lebih profesional — panduan custom domain ada di <a href="/artikel/custom-domain-karsa">cara pasang custom domain di KARSA</a>. Setelah live, daftarkan ke Google Search Console supaya etalase thrift kamu bisa ditemukan orang yang search "toko thrift Jakarta" atau "baju bekas Bandung" — panduan lengkapnya di <a href="/artikel/daftar-google-search-console">cara daftar Google Search Console</a>. Konsistensi update mingguan plus link permanen adalah kombinasi yang membuat toko thrift kecil tetap relevan di antara lapakan yang cuma jualan lewat story.</p>`,
};
