...
'custom-domain-karsa': `
  ...
  'landing-page-produk-herbal': `      <p>Penjual jamu, kapsul, dan skincare herbal Indonesia biasanya mengandalkan testimoni dari chat WhatsApp. Pelanggan pertama senang, kirim testimoni panjang, lalu hilang di antara ratusan pesan. Pembeli kedua ragu karena tidak ada bukti visual rapi, lalu batal checkout. <strong>Landing page produk herbal</strong> yang mobile-friendly memecahkan itu: satu halaman berisi benefit, komposisi, nomor BPOM, testimoni dengan foto, dan tombol pesan — bisa dibuka dari bio Instagram, story, atau status WhatsApp kapan saja.</p>
      ...
      <p>Toko kue tradisional Indonesia biasanya tumbuh dari mulut ke mulut: pelanggan tetap datang karena rasa dan cerita di balik setiap kue. Tapi di luar radius satu kelurahan, toko kamu hampir tidak terlihat. <strong>Website toko kue tradisional</strong> adalah cara paling sederhana untuk membuat pelanggan baru menemukan toko lewat Google, broadcast WhatsApp, atau link yang dishare komunitas — tanpa harus sewa desainer atau developer.</p>
      <h2>Kenapa toko kue tradisional perlu website</h2>
      <p>Kue tradisional seperti lapis legit, klepon, risoles, lumpur, putu, atau nagasari punya kekuatan utama: <strong>resep legenda</strong> yang diwariskan turun-temurun. Kekuatan itu jarang muncul di foto produk, caption singkat, atau story Instagram 24 jam. Website adalah tempat di mana cerita itu bisa ditampilkan lengkap: siapa yang bikin, sejak kapan, bahan apa yang dipakai, dan kenapa rasanya konsisten dari generasi ke generasi.</p>
      <p>Kedua, pelanggan korporat yang cari vendor snack box atau hampers Lebaran hampir selalu cek website dulu sebelum pesan. Kalau tidak ada, mereka pindah ke toko lain yang terlihat lebih profesional, meskipun rasa kue sebanding. Website juga berfungsi sebagai etalase preorder: saat Lebaran, Natal, atau musim Haji tiba, kamu tidak perlu kirim broadcast ratusan chat — pelanggan tinggal buka link, pilih varian, dan konfirmasi sendiri.</p>
      <p>Ketiga, link website permanen bisa dicetak di kemasan, stiker toples, atau kartu nama. Pelanggan yang beli oleh-oleh untuk keluarga di luar kota bisa langsung share link toko kamu, sehingga satu pembelian menghasilkan beberapa pelanggan baru di musim berikutnya.</p>
      <h2>Isi minimum website toko kue tradisional</h2>
      <ul>
        <li><strong>Nama toko dan cerita singkat</strong> — mis. "Kue Lapis Hanjuang, resep keluarga sejak 1972".</li>
        <li><strong>Etalase kue</strong> — foto, nama, harga, label ukuran atau isi (kotak 6, kotak 12, toples).</li>
        <li><strong>Resep legenda dan proses</strong> — apa yang bikin rasa kamu beda dari toko lain, dan bagaimana cara kamu mempertahankan kualitas.</li>
        <li><strong>Preorder musiman</strong> — kalender buka tutup order untuk Lebaran, Natal, Imlek, atau event lokal.</li>
        <li><strong>Alamat, jam buka, dan area kirim</strong> — terutama kalau pelanggan ingin take home langsung.</li>
        <li><strong>Tombol WhatsApp</strong> — floating atau inline, supaya pelanggan langsung chat untuk konfirmasi.</li>
      </ul>
      <p>Tidak perlu keranjang checkout di tahap awal. Untuk kue tradisional, keputusan beli biasanya dimulai dari chat: pelanggan tanya varian, tanya harga grosir, lalu deal. Website cukup menampilkan menu dan cerita; proses transaksi tetap lewat WhatsApp yang sudah kamu kuasai.</p>
      <h2>Contoh prompt untuk KARSA</h2>
      <p>Buka <a href="/app">KARSA</a>, buat proyek web baru, lalu coba prompt di bawah. Ganti teks dalam kurung dengan detail toko kamu sendiri.</p>
      <p><em>"Buat website untuk toko kue tradisional 'Kue Lapis Hanjuang' di Bandung. Header krem dengan logo teks cokelat tua dan tagline 'Resep keluarga sejak 1972'. Section hero berisi foto close-up lapis legit dan tombol 'Pesan via WhatsApp'. Section etalase grid 3 kolom berisi 9 kue (Lapis Legit, Klepon, Putu Bambu, Risoles Sayur, Lumpur Kentang, Nagasari, Kue Mangkok, Bika Ambon, Kue Pepe) lengkap dengan nama, harga Rp 25.000–Rp 180.000, dan label ukuran. Section 'Cerita Kami' berisi paragraf tentang resep warisan, bahan alami, dan proses masak tradisional. Section preorder musiman dengan kalender sederhana (Lebaran, Natal, Imlek). Section testimoni 3 pelanggan dengan nama dan kota. Footer berisi alamat, jam buka, area kirim (Bandung dan Jakarta), dan link Instagram. Floating WhatsApp ke 081234567890. Palet krem, cokelat tua, aksen emas, font serif hangat, mobile-first."</em></p>
      <p>Setelah preview muncul, minta revisi seperlunya: <em>"tambah section FAQ tentang cara kirim ke luar kota"</em>, <em>"ganti palet ke hijau tua dan putih"</em>, atau <em>"buat halaman khusus untuk paket hampers Lebaran"</em>. Tiap iterasi cukup satu kalimat.</p>
      <h2>Foto kue yang menggugah selera tanpa studio</h2>
      <p>Kamera HP sudah cukup. Tiga aturan yang sering dipakai UMKM kuliner: cahaya alami dari samping (bukan flash dari atas), background kayu atau kain polos, dan angle 45 derajat untuk kue bertekstur atau bertingkat. Foto kue basah seperti lapis legit paling bagus diambil dekat jendela di pagi hari — cahaya terang tetapi tidak menyilaukan.</p>
      <p>Tidak perlu foto setiap varian sekaligus. Pilih 6–9 kue signature yang paling laris, lalu ganti foto setiap beberapa bulan supaya etalase terasa hidup. Untuk kue musiman seperti nastar atau kastengel, foto bisa ditambah saat musim preorder dibuka. Resolusi ideal antara 800–1200 piksel di sisi panjang: cukup tajam di HP, tidak membebani loading di jaringan 4G pelanggan.</p>
      <h2>Cara menyebar link website toko kue</h2>
      <p>Setelah preview KARSA sesuai, klik Publish. Toko kamu live di subdomain gratis seperti <code>kue-lapis-hanjuang.karsa.work</code> — tanpa setup hosting, tanpa biaya bulanan. Untuk domain sendiri seperti <code>kuelapishanjuang.com</code>, tambahkan di modal publish dan ikuti instruksi DNS yang diberikan KARSA. Panduan lengkap ada di <a href="/artikel/cara-publish-website-karsa">cara publish website dari KARSA</a>.</p>
      <p>Lalu sebarkan link itu: taruh di bio Instagram toko, deskripsi TikTok, header WhatsApp Business, name tag GoFood/GrabFood (kalau juga jualan di marketplace), dan group WhatsApp komunitas sekitar. Untuk pelanggan yang masih awam, QR code yang dicetak dan ditempel di etalase atau kartu nama juga efektif — mereka tinggal scan, dan website terbuka di HP. Trik yang sering dilupakan: setiap kali kirim pesanan, sisipkan kartu kecil bertuliskan "Pesan lagi lebih gampang via website kami ya kak" lengkap dengan QR code.</p>
      <h2>Mulai sekarang</h2>
      <p>Buka <a href="/app">KARSA</a>, salin prompt di atas, ganti nama toko, daftar kue, dan nomor WhatsApp kamu, lalu lihat preview-nya. Paket gratis sudah termasuk 30 prompt AI per hari — cukup untuk eksplorasi awal tanpa keluar biaya. Untuk variasi lain, pelajari juga <a href="/artikel/katalog-produk-online-umkm">panduan katalog produk online UMKM</a> jika kamu juga jualan kue kering dalam jumlah banyak, dan <a href="/artikel/landing-page-preorder">panduan landing page preorder</a> untuk strategi batch Lebaran atau Natal. Toko kue tradisional punya cerita yang sayang kalau hilang di antara ribuan story — website adalah cara paling sederhana untuk menjaga cerita itu tetap hidup di tangan pelanggan.</p>
      `,
  'website-toko-bunga': `
      <p>Toko bunga atau florist kecil di Indonesia biasanya punya etalase cantik di pinggir jalan — papan bunga, standing flower, bouquet wisuda, dan parcel duka. Tapi di luar jam buka dan di luar radius 1–2 kilometer, toko kamu hampir tidak terlihat. <strong>Website toko bunga</strong> adalah cara paling sederhana untuk membuat pelanggan di kota lain, atau pelanggan yang cari di tengah malam, tetap bisa menemukan tokomu — lengkap dengan katalog, harga, dan cara order lewat WhatsApp.</p>
      <h2>Kenapa toko bunga butuh website, bukan cuma Instagram</h2>
      <p>Instagram memang tempat paling natural untuk foto bouquet dan papan bunga. Masalahnya, feed Instagram bergerak cepat — postingan minggu lalu sudah tenggelam oleh story hari ini. Pelanggan yang cari “toko bunga dekat sini” di Google hampir tidak akan menemukanmu hanya dari Instagram, karena caption dan hashtag tidak diindeks secepat halaman website.</p>
      <p>Website mengubah foto etalase jadi etalase digital permanen. Pelanggan yang butuh standing flower untuk pembukaan toko, parcel duka untuk acara keluarga, atau bouquet wisuda mendadak, biasanya searching di Google atau minta rekomendasi di WhatsApp. Kalau kamu punya link website dengan nama domain yang rapi, mereka langsung cek katalog, lihat harga, lalu chat. Tanpa website, mereka pindah ke florist lain.</p>
      <p>Kedua, momen besar seperti Hari Valentine, wisuda kampus, atau pernikahan musim ramai selalu membuat inbox meledak. Kalau kamu masih jawab satu-satu dengan chat manual, banyak order lewat. Website dengan form preorder sederhana membuat pelanggan isi tanggal, jenis, alamat, dan budget sendiri — kamu tinggal konfirmasi ketersediaan dan kirim.</p>
      <h2>Isi minimum website toko bunga</h2>
      <ul>
        <li><strong>Nama toko dan tagline</strong> — mis. “Florist Anggrek, buket untuk setiap momen spesial”.</li>
        <li><strong>Katalog bouquet dan standing flower</strong> — foto, nama, harga, ukuran, dan jenis bunga utama.</li>
        <li><strong>Katalog papan bunga dan parcel duka</strong> — ukuran, teks ucapan, dan harga per karakter atau paket.</li>
        <li><strong>Preorder musiman</strong> — Valentine, wisuda, pernikahan, Hari Ibu.</li>
        <li><strong>Area kirim dan ongkir</strong> — terutama kalau kamu melayani kirim ke luar kota atau antar pulau.</li>
        <li><strong>Tombol WhatsApp mengambang</strong> — supaya pelanggan tinggal klik untuk konsultasi atau order mendadak.</li>
      </ul>
      <p>Untuk tahap awal, kamu tidak perlu payment gateway. Order besar biasanya tetap deal lewat chat karena pelanggan ingin konsultasi jenis bunga, ukuran, dan tulisan papan. Website cukup menampilkan katalog dan cerita; transaksi tetap lewat WhatsApp.</p>
      <h2>Contoh prompt untuk KARSA</h2>
      <p>Buka <a href="/app">KARSA</a>, buat proyek web baru, lalu coba prompt di bawah. Ganti teks dalam kurung dengan detail toko kamu sendiri.</p>
      <p><em>“Buat website untuk toko bunga ‘Florist Anggrek’ di Jakarta. Header putih bersih dengan logo teks hijau sage dan tagline ‘Buket untuk setiap momen spesial’. Section hero berisi foto bouquet besar dengan tombol ‘Pesan via WhatsApp’. Section etalase grid 3 kolom berisi 9 produk (Bouquet Wisuda, Standing Flower Ucapan, Papan Bunga Duka, Parcel Bunga Anniversary, Buket Hari Valentine, Standing Wedding, Hand Bouquet Mini, Papan Bunga Ucapan Selamat, Buket Hari Ibu) lengkap dengan nama, harga Rp 150.000–Rp 2.500.000, dan label jenis. Section ‘Cerita Kami’ berisi paragraf tentang passion merangkai bunga sejak 2015 dan komitmen kesegaran. Section preorder musiman dengan kalender sederhana (Valentine, Wisuda, Hari Ibu, Musim Pernikahan). Section testimoni 3 pelanggan dengan nama dan kota. Footer berisi alamat, jam buka, area kirim (Jakarta, Bekasi, Tangerang), dan link Instagram. Floating WhatsApp ke 081234567890. Palet putih, hijau sage, blush pink, font serif elegan, mobile-first.”</em></p>
      <p>Setelah preview muncul, minta revisi seperlunya: <em>“tambah section FAQ tentang cara pesan mendadak 2 jam sebelumnya”</em>, <em>“ganti palet ke krem dan dusty rose”</em>, atau <em>“buat halaman khusus untuk paket wedding standing flower”</em>. Tiap iterasi cukup satu kalimat.</p>
      <h2>Foto buket yang menggugah tanpa studio mahal</h2>
      <p>Kamera HP sudah cukup untuk etalase florist kecil. Tiga aturan yang sering dipakai toko bunga modern: cahaya alami dari samping (idealnya dekat jendela di pagi atau sore), background polos (kain linen, kertas kraf, atau meja kayu), dan angle 45 derajat untuk bouquet agar volume bunga terlihat. Standing flower paling bagus difoto dari samping dengan sedikit angle agar tinggi dan lebar papan terlihat.</p>
      <p>Tidak perlu foto semua varian sekaligus. Pilih 6–9 best seller yang paling sering dipesan — bouquet wisuda, standing flower, papan duka, parcel anniversary, hand bouquet, papan ucapan. Ganti foto setiap 1–2 bulan supaya etalase terasa hidup, atau tambah foto musiman saat Valentine atau wisuda tiba. Resolusi ideal 800–1200 piksel: cukup tajam di HP, tidak membebani loading di 4G.</p>
      <h2>Cara menyebar link website toko bunga</h2>
      <p>Setelah preview KARSA sesuai, klik Publish. Tokomu live di subdomain gratis seperti <code>florist-anggrek.karsa.work</code> — tanpa setup hosting, tanpa biaya bulanan. Untuk domain sendiri, tambahkan di modal publish dan ikuti instruksi DNS KARSA. Panduan lengkap di <a href="/artikel/cara-publish-website-karsa">cara publish website dari KARSA</a>.</p>
      <p>Lalu sebarkan link itu: taruh di bio Instagram toko, header WhatsApp Business, name tag marketplace (kalau juga jualan di Tokopedia/Shopee), dan group WhatsApp komunitas sekitar. Untuk pelanggan corporate yang rutin pesan parcel ucapan, link website di email signature juga efektif. Trik yang sering dilupakan: setiap kali kirim bouquet, sisipkan kartu kecil bertuliskan “Pesan bouquet lagi via website kami ya kak” lengkap dengan QR code — satu pelanggan yang puas jadi sumber order berikutnya.</p>
      <h2>Mulai sekarang</h2>
      <p>Buka <a href="/app">KARSA</a>, salin prompt di atas, ganti nama toko, daftar produk, dan nomor WhatsApp kamu, lalu lihat preview-nya. Paket gratis sudah termasuk 30 prompt AI per hari — cukup untuk eksplorasi awal tanpa keluar biaya. Untuk variasi lain, pelajari juga <a href="/artikel/katalog-produk-online-umkm">panduan katalog produk online UMKM</a> jika tokomu juga jual tanaman pot, dan <a href="/artikel/landing-page-preorder">panduan landing page preorder</a> untuk strategi batch Valentine. Toko bunga punya pesona yang sayang kalau hilang di antara ribuan story — website adalah cara paling sederhana untuk menjaga pesona itu tetap hidup.</p>
      `,
  'website-jasa-les-privat': `
      <p>Les privat biasanya tumbuh dari mulut ke mulut: tetangga cerita ke RT, murid yang lulus memberi kabar ke adiknya, dan grup WhatsApp orang tua sekolah jadi etalase utama. Cara ini memang efektif, tapi kapasitasmu terbatas pada satu kelurahan dan waktu-waktu senggang yang tidak konsisten. <strong>Website jasa les privat</strong> adalah cara paling sederhana untuk mengubah reputasi dari mulut ke mulut jadi link permanen yang bisa dishare ke orang tua baru — lengkap dengan profil tutor, mata pelajaran, harga, dan form booking yang otomatis masuk ke WhatsApp.</p>
      <h2>Kenapa tutor les privat butuh website, bukan cuma poster</h2>
      <p>Orang tua yang cari tutor untuk anaknya hampir selalu cek jejak digital dulu sebelum deal. Mereka ingin tahu siapa tutor-nya, latar belakang pendidikan, pengalaman mengajar, mata pelajaran yang dikuasai, dan testimoni dari murid sebelumnya. Semua informasi itu sulit ditampilkan lengkap di poster A3 di papan pengumuman sekolah atau pesan broadcast WhatsApp yang cepat tenggelam. Website memberikan ruang khusus di mana reputasimu tampil rapi, profesional, dan mudah dishare.</p>
      <p>Kedua, banyak tutor dan bimbel kecil akhirnya kewalahan saat musim ujian atau pendaftaran sekolah. Chat masuk ratusan, harus dijawab satu-satu, dan tidak jarang slot bentrok. Website dengan form booking otomatis membuat orang tua pilih sendiri tutor, mata pelajaran, jadwal, dan paket yang tersedia. Kamu tinggal konfirmasi ketersediaan di akhir hari, tidak harus stand-by chat dari pagi sampai malam.</p>
      <p>Ketiga, link website permanen bisa dicetak di kartu nama, stiker buku catatan murid, atau QR code yang ditempel di mading sekolah. Orang tua yang puas dengan hasil les anaknya tinggal share link itu ke grup orang tua sekolah lain — tanpa kamu harus jualan. Pertumbuhan murid baru jadi organik, bukan dari iklan yang mahal.</p>
      <h2>Isi minimum website jasa les privat</h2>
      <ul>
        <li><strong>Profil tutor dan latar belakang</strong> — pendidikan, pengalaman mengajar, sertifikasi, dan spesialisasi mata pelajaran.</li>
        <li><strong>Daftar mata pelajaran dan jenjang</strong> — SD, SMP, SMA, hingga ujian masuk PTN atau bahasa Inggris dewasa.</li>
        <li><strong>Paket les dan harga</strong> — per jam, per sesi, paket bulanan, paket intensif ujian, les online atau offline.</li>
        <li><strong>Jadwal tersedia</strong> — slot mingguan, hari libur, dan kebijakan reschedule.</li>
        <li><strong>Testimoni orang tua dan murid</strong> — nilai yang naik, kelulusan ujian, dan cerita pendek dari mereka yang sudah pernah les.</li>
        <li><strong>Form booking atau tombol WhatsApp</strong> — supaya orang tua tinggal klik untuk mulai.</li>
      </ul>
      <p>Untuk tahap awal, kamu tidak perlu payment gateway. Les privat biasanya deal lewat chat: orang tua tanya jadwal, coba satu sesi dulu, lalu lanjut paket bulanan. Website cukup menampilkan profil, mata pelajaran, dan testimoni; transaksi tetap via WhatsApp yang sudah kamu kuasai.</p>
      <h2>Contoh prompt untuk KARSA</h2>
      <p>Buka <a href="/app">KARSA</a>, buat proyek web baru, lalu coba prompt di bawah. Ganti teks dalam kurung dengan detail les privat kamu sendiri.</p>
      <p><em>“Buat website untuk jasa les privat ‘Tutor Cendekia’ di Yogyakarta. Header putih bersih dengan logo teks navy dan tagline ‘Les privat SD–SMA, ujian PTN, bahasa Inggris’. Section hero berisi foto tutor sedang mengajar dengan tombol ‘Daftar Trial Les’. Section profil tutor grid 3 kolom berisi 4 tutor (Bu Sari – Matematika SMA, Pak Andi – Fisika & Kimia, Mbak Rina – Bahasa Inggris SD & SMP, Mas Dimas – Persiapan UTBK) lengkap dengan nama, gelar, pengalaman mengajar (5–12 tahun), dan spesialisasi. Section mata pelajaran dan jenjang grid 4 kolom (Matematika, Fisika, Kimia, Biologi, Bahasa Indonesia, Bahasa Inggris, IPS, Persiapan UTBK). Section paket les tabel 3 kolom (Paket Reguler Rp 75.000/jam, Paket Intensif Ujian Rp 100.000/jam, Paket Bulanan 8 sesi Rp 550.000) lengkap dengan durasi, jumlah sesi, dan benefit. Section jadwal tersedia dengan kalender slot mingguan (Senin–Sabtu, 15.00–21.00). Section testimoni 3 orang tua dengan nama dan kota. Footer berisi area layanan (Yogyakarta, Sleman, Bantul), link WhatsApp, dan email. Floating WhatsApp ke 081234567890. Palet putih, navy, aksen kuning mustard, font sans-serif modern, mobile-first.”</em></p>
      <p>Setelah preview muncul, minta revisi seperlunya: <em>“tambah section FAQ tentang kebijakan reschedule”</em>, <em>“ganti palet ke hijau tua dan krem”</em>, atau <em>“buat halaman khusus untuk paket intensif UTBK”</em>. Tiap iterasi cukup satu kalimat.</p>
      <h2>Cara menyebarkan link website les privat</h2>
      <p>Setelah preview KARSA sesuai, klik Publish. Les privat kamu live di subdomain gratis seperti <code>tutor-cendekia.karsa.work</code> — tanpa setup hosting, tanpa biaya bulanan. Untuk domain sendiri seperti <code>tutorcendekia.com</code>, tambahkan di modal publish dan ikuti instruksi DNS yang diberikan KARSA. Panduan lengkap ada di <a href="/artikel/cara-publish-website-karsa">cara publish website dari KARSA</a>.</p>
      <p>Lalu sebarkan link itu: taruh di bio Instagram tutor, header WhatsApp Business, name tag marketplace (kalau juga jualan modul di Shopee), grup WhatsApp orang tua sekolah, dan mading sekolah setelah izin dari guru BK. Untuk murid yang sudah lulus dan sekarang kuliah, minta mereka tulis testimoni singkat dan izin share link website ke adik kelas. Trik yang sering dilupakan: setiap kali les pertama selesai dan orang tua puas, langsung kirim pesan sopan berisi tautan website lengkap dengan QR code untuk dishare ke grup orang tua lain. Satu murid puas jadi sumber tiga murid baru di semester berikutnya.</p>
      <h2>Mulai sekarang</h2>
      <p>Buka <a href="/app">KARSA</a>, salin prompt di atas, ganti nama les, daftar tutor, mata pelajaran, dan nomor WhatsApp kamu, lalu lihat preview-nya. Paket gratis sudah termasuk 30 prompt AI per hari — cukup untuk eksplorasi awal tanpa keluar biaya. Untuk variasi lain, pelajari juga <a href="/artikel/form-booking-online-umkm">panduan form booking online UMKM</a> agar form di website kamu terhubung rapi ke WhatsApp, dan <a href="/artikel/website-portfolio-mahasiswa">panduan website portfolio mahasiswa</a> untuk mahasiswa yang juga menerima les privat sambil kuliah. Reputasi sebagai tutor adalah aset jangka panjang — website adalah cara paling sederhana untuk menjaga reputasi itu tetap hidup di tangan orang tua yang baru mengenalmu.</p>
      `,
      };
